/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 6c1e30aee139d36e4ba5b26325c0e3b3)
// Runtime types generated with workerd@1.20251008.0 2025-10-16 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	...
	interface Env {
		...
		PDF_PARSING_URL: string;
		MODAL_TOKEN_ID: string;
		MODAL_TOKEN_SECRET: string;
		MODAL_YOLO_URL: string;
		NCBI_API_KEY: string;
		BRIGHTDATA_API_KEY: string;
		BRIGHTDATA_WORKER: string;
		BUCKET_NAME: string;
		XAI_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_VAR" | "API_TOKEN" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_BUCKET_ID" | "CLOUDFLARE_ACCESS_KEY_ID" | "CLOUDFLARE_SECRET_ACCESS_KEY" | "ACCOUNT_ID" | "ACCESS_KEY_ID" | "SECRET_ACCESS_KEY" | "OPENROUTER_API_KEY" | "GOOGLE_GENERATIVE_AI_API_KEY" | "EXA_API_KEY" | "PERPLEXITY_API_KEY" | "OPENAI_API_KEY" | "TRIGGER_SECRET_KEY" | "PDF_PARSING_URL" | "MODAL_TOKEN_ID" | "MODAL_TOKEN_SECRET" | "MODAL_YOLO_URL" | "NCBI_API_KEY" | "BRIGHTDATA_API_KEY" | "BRIGHTDATA_WORKER" | "BUCKET_NAME" | "XAI_API_KEY" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "NODE_ENV" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BRAINTRUST_API_KEY" | "AXIOM_API_KEY">> {}
}
